...
public class Contact_EmailIDFirstName_EditPageTest extends BaseClass {
	
	@Test 
	public void contact_EmailIDFirstName_EditPageTest() throws Throwable
	{
		...
		//step 4 -create one contact
			String FirstName = flib.getExcelData("Sheet1", 1, 2);
			String LastName =  flib.getExcelData("Sheet1", 1, 3);
			String EmailId =  flib.getExcelData("Sheet1", 1, 4);
			cp.createContactWithemailId(FirstName, LastName, EmailId);
